...
import com.ok.utils.utils.ResourceUtils;
...
public class JufanBoatView extends RelativeLayout {
    ...
    private void init() {
        ...
        ship_img.setImageBitmap(ResourceUtils.getBitmapImage(SHIP_POSITION, mContext));
        ...
        lang2.setAlpha(.3f);
        lang3.setAlpha(.1f);
        lang1.setImageBitmap(ResourceUtils.getBitmapImage(lang_Position[0], mContext));
        lang2.setImageBitmap(ResourceUtils.getBitmapImage(lang_Position[1], mContext));
        lang3.setImageBitmap(ResourceUtils.getBitmapImage(lang_Position[2], mContext));
        ...
        head.setImageBitmap(ResourceUtils.getBitmapImage(HEAD_POSITION, mContext));
        head.setAlpha(0.0f);
    }
