...
import com.ok.utils.utils.SizeUtils;
...
public class PullToRefreshView extends ViewGroup {
    ...
    public PullToRefreshView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.li_RefreshView);
        final int type = a.getInteger(R.styleable.li_RefreshView_type, STYLE_SUN);
        a.recycle();
...
//                mBaseRefreshView = new SunRefreshView(getContext(), this);
                mBaseRefreshView = new LiveRefreshView(getContext(),this);
                break;
            default:
    ...
    private final Animation mAnimateToCorrectPosition = new Animation() {
        ...
        public void applyTransformation(float interpolatedTime, Transformation t) {
            ...
            Logger.d("refreshing value "+offset);
    ...
    private void setTargetOffsetTop(int offset, boolean requiresUpdate) {
        Logger.d("setTargetOffsetTop offset "+offset );
