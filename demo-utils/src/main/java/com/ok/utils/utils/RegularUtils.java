...
public class RegularUtils {
    ...
    //private static final String REGEX_MOBILE_EXACT="^((13[0-9])|(17[^4,\\D])|(15[^4,\\D])|(18[^1^4,\\D]))\\d{8}";
    /**
     ...
     * 身份证号码验证
     */
    private static final String REGEX_CARD = "^[0-9]{17}[0-9xX]$";
    /**
     * 小数点位数
     *
     * @param string   可能包含小数点的字符串
     * @param length 小数点后的长度
     * @return 是否小数点后有length位数字
     */
    public static boolean isDianWeiShu(String string, int length) {
        String expr = "^[1-9][0-9]+\\.[0-9]{" + length + "}$";
        return isMatch(expr,string);
    }
    /**
     * @param string 待验证文本
    ...
    /**
     * @param string 可能是身份证号码的字符串
     * @return 是否是身份证号码
     */
    public static boolean isCard(String string) {
        return isMatch(REGEX_CARD,string);
    }
